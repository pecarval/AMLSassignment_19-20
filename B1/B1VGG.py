...
class B1:
    ...
    def train(self, dataloader, sizes, num_epochs=25):
        ...
        plot_loss_curve(losses, num_epochs, 'Train and Validation Losses in Task B1 (Pre-trained VGG)')
        plot_acc_curve(accs, num_epochs, 'Train and Validation Accuracies in Task B1 (Pre-trained VGG)')
