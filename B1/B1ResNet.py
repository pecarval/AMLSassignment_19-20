...
class B1:
    ...
    def train(self, dataloader, sizes):
        ...
        plot_loss_curve(losses, self.NUM_EPOCHS, 'Train and Validation Losses in Task B1 (Pre-trained ResNet)')
        plot_acc_curve(accs, self.NUM_EPOCHS, 'Train and Validation Accuracies in Task B1 (Pre-trained ResNet)')
