...
class B1:
    ...
    def __init__(self):
        ...
        parameters found in Grid Search CV (file: hyperparametersB1model1.ipynb)
        '''
    ...
    def train(self, data_train, lbs_train):
        ...
        plot_learning_curve(SVC(C=30, kernel='rbf', gamma=0.001, probability=True, random_state=42),"Learning Curve for B1 Task (SVM with facial landmarks)", data_train, lbs_train,cv=5)
