...
class B2:
    ...
    def train(self, dataloader, sizes, num_epochs=25):
        ...
        plot_loss_curve(losses, num_epochs, 'Train and Validation Losses in Task B2 (Pre-trained ResNet)')
        plot_acc_curve(accs, num_epochs, 'Train and Validation Accuracies in Task B2 (Pre-trained ResNet)')
    ...
    def test(self, dataloader):
        '''
        Test the ResNet model on previously unseen data
