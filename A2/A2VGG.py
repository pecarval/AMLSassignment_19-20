...
class A2:
    ...
    def train(self, dataloader, sizes):
        ...
        plot_loss_curve(losses, self.NUM_EPOCHS, 'Train and Validation Losses in Task A2 (Pre-trained VGG)')
        plot_acc_curve(accs, self.NUM_EPOCHS, 'Train and Validation Accuracies in Task A2 (Pre-trained VGG)')
