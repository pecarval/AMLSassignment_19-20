...
dataA2_train1, dataA2_test1, lbsA2_train1, lbsA2_test1 = dataA2.mainA2Landmarks()
dataA2_2, dataset_sizes = dataA2.mainA2VGG()
...
print('TA2_1:{},{};TA2_2:{},{};'.format(acc1_A2_train, acc1_A2_test,
                                        acc2_A2_train, acc2_A2_test))
