...
def extract_features_labels(dire):
    """
    This funtion extracts the landmarks features for all images in the folder 'dataset/cartoon_set'.
    It also extracts the face shape recognition label for each image.
